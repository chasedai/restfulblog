...
<body>
	...
	<div class="container">
		<div>
			<input type="text" id="postTitle" name="title" style="width: 650px" value="New title here">
		</div>
		<div class="hero-unit">
			...
			<a href="javascript:void(0);" onclick="newPost()">Submit new post</a> &nbsp;
			<a href="javascript:void(0);" onclick="updatePost()">Update this post</a>
		</div>
		<div>
			<input type="text" id="tobeDeleted" name="deleting" value="ID of the post you want to delete.">
			<a href="javascript:void(0);" onclick="renderPost()">Display</a> &nbsp;
			<a href="javascript:void(0);" onclick="deletePost()">Delete</a>
		</div>
	</div>
</body>
